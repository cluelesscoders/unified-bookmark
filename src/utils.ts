...
export const chromeTimeParser = (webkitTimestamp: string) => {
  const timestamp = parseInt(webkitTimestamp, 10);
  const dateInSeconds = Math.round(timestamp / 1000000) - 11644473600
  return new Date(dateInSeconds * 1000).toISOString()
}
